...
$('.event_box2 .page_act .btn_stop').click(function (ev) {
    ev.preventDefault();
...
$('.event_box2 .page_act .btn_play').click(function (ev) {
    ev.preventDefault();
...
$('.event_box3 .pagn_act .btn_stop').click(function(ev){
    ev.preventDefault();
...
$('.event_box3 .pagn_act .btn_play').click(function(ev){
    ev.preventDefault();
